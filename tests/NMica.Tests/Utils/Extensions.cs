...
namespace NMica.Tests.Utils
{
    public static class Extensions
    {
        ...
        public static DockerRunSettings AddVolume(this DockerRunSettings settings, MountedPath path) => 
            settings.AddVolume($"{path.HostPath.ToDockerfilePath()}:{path.ToDockerfilePath()}");
